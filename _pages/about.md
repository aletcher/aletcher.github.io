...
Research interests: AI safety, reinforcement & multi-agent learning, world models, game theory, evolution strategies. Currently working on (1) extracting world models from model-free agents, and (2) implicitly promoting cooperation among self-interested AI agents using indirect reciprocity (aka reputation). Nerd for math puzzles like the [EM sequence density](https://mathenchant.wordpress.com/2019/10/16/guess-again-the-ehrenfeucht-mycielski-sequence/). Lover of contemporary dance and poetry.
